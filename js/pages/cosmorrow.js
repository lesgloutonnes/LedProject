      ...
      .map(function (f) {
        return (
          ...
          e(f.spectrum && f.spectrum.kind === "full-spectrum"
            ? "Parts de diodes (fiche), pas une SPD. 660 nm = rouge PAR, pas du rouge lointain 730 nm. Blanc 2700 K = pompe 450 nm + luminophore ~610 nm."
            : "100 % diodes 6500 K (parts de diodes, pas une SPD). Blanc froid : internodes courts au germoir.") +
          "</p></article>"
        );
      })
      .join("");
