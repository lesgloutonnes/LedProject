...
export const FIXTURES: FixtureSetup[] = [
  ...
  },
  {
    ...
    notes: "Le PAR 230 est identique sur les Slim 45, 55, 74 et 93. Pic sous la rampe, pas une moyenne. Conversion lumens ≈ 45 µmol/s ; pour coller au pic 230 on retient ~91 µmol/s (1,78 µmol/J). Même dans ce cas optimiste, 2 Slim restent sous 2 Cosmorrow en photons, pour 22 W de plus.",
    spectrum: "Blanc 7000 K, CRI 96, pic bleu ~448 nm + phosphore. Pas de pic 660 nm dédié — ce n’est pas un défaut pour des carnivores.",
    dimmable: true,
    ip: "IP67",
    peakPpfdAt20: 230,
