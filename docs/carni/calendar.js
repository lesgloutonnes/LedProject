  ...
  months: [
    {
      ...
      gestures: [
        "Contrôle hebdomadaire des pots en dormance : poids, pourriture, jamais de bac d’eau. Dehors : un coup de vent desséchant se rattrape à l’eau RO, pas au radiateur.",
        "Cosmorrow loin (30–50 cm) seulement si les dormantes sont encore en tente. Dehors : pas de LED.",
        ...
        "Tropicales : rythme normal, foliar 0,3 g/L si c’est leur créneau mensuel.",
      ],
      notes: "Les pièges noirs de dionée sont en poste, pas à la poubelle. Un châssis à 2 °C vaut mieux qu’une tente à 20 °C / 9 h.",
    },
    {
      id: 2,
      name: "Février",
    ...
    },
    {
      ...
      gestures: [
        ...
        "Gelées derrière : Sarracenia et Dionaea adultes dehors (plein soleil, bac de pluie). La tente garde germoir, tropicales, et l’appartement sans extérieur.",
    ...
    },
    {
      ...
      gestures: [
        "Production indoor : foliar 1–2×/mois, proies 1–2×/mois.",
        "Tempérées adultes : dehors si tu as le soleil — la tente n’est pas un substitut d’été.",
    ...
    },
    {
      ...
      gestures: [
        "Extracteur : priorité pour ce qui reste en tente. Cosmorrow chauffe peu, la tente fermée au soleil chauffe beaucoup.",
        "Cephalotus et highland : ombre et air, ne pas les coller au plafond 30 °C.",
        "Colorisation dressées indoor : DLI haut, nuits les plus fraîches que tu peux. Dehors, le soleil de juin fait le travail.",
    ...
    },
    {
      ...
      gestures: [
        ...
        "Sortir les dionées / sarracènes / drosera tempérées de la tente mixte chaude — dehors ou garage, pas « 8 h dans la même tente à 22 °C ».",
      ...
      notes: "Mois charnière FR/BE. Un châssis ou un garage hors gel = protocole. Un radiateur + 14 h = faux été. Cosmorrow ne remplace pas le thermomètre.",
    },
    {
      id: 11,
      name: "Novembre",
      photoperiod: "Dormantes : 8–10 h. Tropicales : 12–14 h.",
      gestures: [
        "Dormance installée : 0–10 °C, mix juste humide, contrôle pourriture. Dehors prioritaire.",
